...
const hiringProductTeam: FormConfig = {
  ...
  description:
    "We're hiring across engineering, quality and design. Pick your role — we'll only ask what's relevant to it.",
  client: 'Maxxlab',
  layout: 'steps',
  ...
  sections: [
    // ── 01 · Role picker (always shown) ──────────────────────────────────────
    {
      ...
      description:
        'Pick one — the rest of the form changes to match. All three are fully remote with a paid trial period first.',
      fields: [
        {
          id: ROLE_FIELD,
          type: 'radio',
    ...
    // ── Role brief · Full-Stack ──────────────────────────────────────────────
    {
      ...
      fields: [
        ...
        },
        {
          ...
          variant: 'callout',
          body: [
            'You’ll have direct access to the founders and work closely with a technical lead who reviews your code and helps you grow, not just approves PRs. We bring people on with a paid trial period first, so both sides can be confident in the fit, after which strong performers move into a permanent, long-term role on the team. Because our client projects vary, you’ll get exposure to new stacks and problems over time rather than being locked into one codebase.',
    ...
    // ── Role brief · QA ──────────────────────────────────────────────────────
    {
      ...
      description: 'Product Quality & Release Testing — fully remote.',
      ...
      fields: [
        ...
        },
        {
          ...
          variant: 'callout',
          body: [
            'You’ll have direct access to the founders and work closely with a technical lead who helps you grow. We bring people on with a paid trial period first, so both sides can be confident in the fit, after which strong performers move into a permanent, long-term role on the team. Because our client projects vary, you’ll get exposure to new products and problems over time rather than being locked into one codebase.',
            'Location: fully remote, with working-hours overlap on Canadian business hours (~9–5 ET).',
          ],
        },
      ],
    ...
    // ── Role brief · UI/UX ───────────────────────────────────────────────────
    {
      ...
      description: 'Figma + Design Systems — fully remote.',
      ...
      fields: [
        ...
        },
        {
          ...
          body: [
            ...
            'You’ll have direct access to the founders and work closely with developers and a technical lead. We bring people on with a paid trial period first; strong performers move into a permanent, long-term role. Because our client projects vary, you’ll work across different products, industries, and design challenges rather than one visual style.',
            'Location: fully remote, with working-hours overlap on Canadian business hours (~9–5 ET).',
          ],
        },
      ],
    ...
    // ── About you (always shown) ─────────────────────────────────────────────
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'radio',
          layout: 'pills',
          label: 'We start everyone on a paid trial period. Does that work for you?',
          options: [
            { value: 'yes', label: 'Yes' },
    ...
    // ── Skills · QA ──────────────────────────────────────────────────────────
    {
      ...
      description: 'How you test, and how you write it up.',
      showIf: { field: ROLE_FIELD, equals: ['qa'] },
      fields: [
        {
          id: 'qa_core_skills',
        ...
        },
        {
          id: 'qa_edge_case',
          type: 'textarea',
          label: 'Describe the best bug you ever found',
          hint: "What made it hard to catch, how you found it, and how you wrote it up. Happy-path bugs don't count.",
          rows: 4,
        },
        {
          id: 'qa_sample_link',
          type: 'url',
          label: 'Link to a sample bug report, test plan, or QA portfolio',
          hint: 'Redacted is fine. You can also upload the file in the next section.',
        },
      ],
    },
    ...
    // ── Availability (always shown) ──────────────────────────────────────────
    {
      ...
      description:
        'Fully remote, with a paid trial period first and a long-term seat after it if the fit is right.',
      fields: [
        { id: 'start_date', type: 'date', label: 'Earliest start date', halfWidth: true },
        {
          ...
          hint: 'Monthly or hourly — whatever is easiest to compare. Include your currency.',
          placeholder: 'e.g. $110/month USD',
          halfWidth: true,
        },
        {
          id: 'weekly_hours',
